...
\begin{enumerate}
    ...
    web workers. Services for ineracting with external resources like mouse/keyboard events, geolocation changes,
    output from an extrenal JavaScript library, and websocket messages. Futures are Rust's representation of an 
    asynchronus operation's success (or failure) and its value, 
...
\begin{itemize}
    ...
    implemented, Intervals with a Callback Function and Interval as ``Stream''s, 

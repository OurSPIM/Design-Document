...
For the sake of this project, only one ALU is required in the primary unit,
and an additional floating-point ALU is required in the floating-point
unit. We do not foresee the need for a more complex ALU or multiple
units given the planned supported instructions.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            double-precision floating-point operation (1). This fifth bit is

...
UTF-8 characters in within the double quotes characters.
...
the two characters are instead read as the correlated escape character instead of as two separate characters (e.g., \textbackslash\textbackslash\textbackslash{n} is read as 0x0A instead of 0x5C41).
